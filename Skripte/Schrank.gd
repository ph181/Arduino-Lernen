...
func _on_CloseRaum_mouse_entered():
	get_parent().get_node("CloseRaum").scale *= 1.2
...
func _on_SaegenClose_mouse_entered():
	$alleSaegen/SaegenClose.scale *= 1.2
...
func _on_Feile_mouse_entered():
	...
	get_node("FeileRaspel/Feile/TextureRect").scale *= 1.2
...
func _on_Raspel_mouse_entered():
	...
	get_node("FeileRaspel/Raspel/TextureRect").scale *= 1.2
...
func _on_MaschinenClose2_mouse_entered():
	$alleMaschinen/MaschinenClose2.scale *= 1.2
